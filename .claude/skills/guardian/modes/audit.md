...
Bounded health review; require a scope (ask if missing). Run the Deep baseline; score the scope by dimension; reconcile declared-vs-enforced; review cross-tool instructions; check boundary enforcement; list findings with IDs; propose a safe sequence.
